...
const contacts = [
  {
    label: 'Email',
    value: 'ikajalpatel21@gmail.com',
    href: 'mailto:ikajalpatel21@gmail.com',
    icon: (
  ...
  return (
    <section id="contact" className="section">
      ...
      <p className="contact-subtitle">
        Open to data engineering and AI infrastructure roles. If you're working on something that demands both depth and clarity, I'd like to hear about it.
      </p>
      <div ref={gridRef} className="contact-grid animate animate-delay-1">
        {contacts.map(c => (
